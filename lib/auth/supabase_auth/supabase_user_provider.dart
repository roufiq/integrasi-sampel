...
class IntegrasiSurveiSampelPerusahaanSupabaseUser extends BaseAuthUser {
  IntegrasiSurveiSampelPerusahaanSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> integrasiSurveiSampelPerusahaanSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          IntegrasiSurveiSampelPerusahaanSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
