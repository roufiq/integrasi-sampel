...
class HistoryMitra1371Table extends SupabaseTable<HistoryMitra1371Row> {
  @override
  String get tableName => 'history_mitra_1371';

  @override
  HistoryMitra1371Row createRow(Map<String, dynamic> data) =>
      HistoryMitra1371Row(data);
}

class HistoryMitra1371Row extends SupabaseDataRow {
  HistoryMitra1371Row(super.data);

  @override
  SupabaseTable get table => HistoryMitra1371Table();
