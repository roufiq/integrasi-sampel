...
class Mitra1300AllTable extends SupabaseTable<Mitra1300AllRow> {
  @override
  String get tableName => 'mitra_1300_all';

  @override
  Mitra1300AllRow createRow(Map<String, dynamic> data) => Mitra1300AllRow(data);
}

class Mitra1300AllRow extends SupabaseDataRow {
  Mitra1300AllRow(super.data);

  @override
  SupabaseTable get table => Mitra1300AllTable();
  ...
  String? get sobatId => getField<String>('sobat_id');
  set sobatId(String? value) => setField<String>('sobat_id', value);
  ...
  String? get kodeSatker => getField<String>('kode_satker');
  set kodeSatker(String? value) => setField<String>('kode_satker', value);
}
