...
class Publikasi1371Table extends SupabaseTable<Publikasi1371Row> {
  @override
  String get tableName => 'publikasi_1371';

  @override
  Publikasi1371Row createRow(Map<String, dynamic> data) =>
      Publikasi1371Row(data);
}

class Publikasi1371Row extends SupabaseDataRow {
  Publikasi1371Row(super.data);

  @override
  SupabaseTable get table => Publikasi1371Table();
