...
class MitraTable extends SupabaseTable<MitraRow> {
  @override
  String get tableName => 'mitra';

  @override
  MitraRow createRow(Map<String, dynamic> data) => MitraRow(data);
}

class MitraRow extends SupabaseDataRow {
  MitraRow(super.data);

  @override
  SupabaseTable get table => MitraTable();
