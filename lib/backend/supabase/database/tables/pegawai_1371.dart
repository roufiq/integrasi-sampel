...
class Pegawai1371Table extends SupabaseTable<Pegawai1371Row> {
  @override
  String get tableName => 'pegawai_1371';

  @override
  Pegawai1371Row createRow(Map<String, dynamic> data) => Pegawai1371Row(data);
}

class Pegawai1371Row extends SupabaseDataRow {
  Pegawai1371Row(super.data);

  @override
  SupabaseTable get table => Pegawai1371Table();
