  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case PembayaranRow:
            return PembayaranRow(data);
          case History1371ViewRow:
            return History1371ViewRow(data);
          case Mitra1300AllRow:
          ...
          case PegawaiKipapp1371Row:
            return PegawaiKipapp1371Row(data);
          case MitraRow:
            return MitraRow(data);
          case Profile1371Row:
            return Profile1371Row(data);
          case PosKegSurveyRow:
            return PosKegSurveyRow(data);
          case SurveiRow:
            return SurveiRow(data);
          case HistoryMitra1371Row:
          ...
          case GlosariumRow:
            return GlosariumRow(data);
          case ProgressPegawaiRow:
            return ProgressPegawaiRow(data);
          case PublikasiRow:
            return PublikasiRow(data);
          case KegSurveyPjKegViewRow:
          ...
          case PegawaiPosRow:
            return PegawaiPosRow(data);
          case Timkerja1371Row:
            return Timkerja1371Row(data);
          case SampelUsahaRow:
            return SampelUsahaRow(data);
          case ProgressPegawaiByidViewRow:
            return ProgressPegawaiByidViewRow(data);
          case TabelStatisRow:
            return TabelStatisRow(data);
          default:
            return null;
        }
